                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('basic_information',null, ['class' => 'form-control', 'autocomplete' => 'off','style'=>'height:80px','maxLength'=>'500','id' => 'basic_information', 'required']) }}
                            ...
                            <div class="row">
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('traditional_language', null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'traditional_language', 'style'=>'height:80px','maxLength'=>'500', 'required']) }}
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('traditional_dance_description', null, ['class' => 'form-control','style'=>'height:80px','maxLength'=>'500', 'autocomplete' => 'off', 'id' => 'traditional_dance_description', 'required']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('traditional_food_description', null, ['class' => 'form-control', 'autocomplete' => 'off','style'=>'height:80px','maxLength'=>'500', 'id' => 'traditional_food_description', 'required']) }}
                            ...
                            <div class="row">
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('culture_history', null, ['class' => 'form-control', 'autocomplete' => 'off','id' => 'culture_history', 'style'=>'height:80px','maxLength'=>'500','required']) }}
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('cultural_video', null, ['class' => 'form-control', 'autocomplete' => 'off','id' => 'cultural_video']) }}
                                ...
                                <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('conclusion', null, ['class' => 'form-control', 'autocomplete' => 'off','maxLength'=>'500','style'=>'height:80px','id' => 'conclusion','required']) }}
                                        ...
                                        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <table>
                                                ...
                                                <tr id="appreciationActivity">
                                                    <td><input type="text" class="form-control" maxlength="500" name="appreciation_activity_detail1" required></td>
                                        ...
                                        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <table>
                                                ...
                                                <tr id="challengeDetail">
                                                    <td><input type="text" class="form-control" maxlength="500" name="culture_challenges_detailed1" required></td>
    ...
    <script>
        $(document).ready(function (){
            ...
            $('#addAppreciationActivity').on('click',function (){
               ...
               var html='';
               html += '<tr>';
               html += '<td><input type="text" class="form-control" maxlength="500" name="appreciation_activity_detail'+i+'" required></td>';
               html += '<td><a class="fas fa-pencil-alt danger" id="removeAppreciationActivity">-</a></td>';
               html += '</tr>';
               $('#appreciationActivity').append(html);
            })
    ...
    <script>
        $(document).ready(function (){
            ...
            $('#addChallengeDetail').on('click',function (){
               ...
               var html='';
               html += '<tr>';
               html += '<td><input type="text" class="form-control" maxlength="500" name="culture_challenges_detailed'+i+'" required></td>';
               html += '<td><a class="fas fa-pencil-alt danger" id="removeChallengeDetail">-</a></td>';
               html += '</tr>';
               $('#challengeDetail').append(html);
            })

    ...
    <div class="row">
        <div class="col-md-12">
            <div class="section-header mb-4">
                ...
                <p class="section-subtitle">Explore more experience as you are in <a href="{{route('touristicAttraction.show',$tanzaniaRegion->uuid)}}">{{$tanzaniaRegion->region_name}}</a></p>
            </div>

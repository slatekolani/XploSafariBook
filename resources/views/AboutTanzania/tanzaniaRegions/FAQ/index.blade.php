    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12" >
            <div class="pull-right" style="margin-bottom: 10px">
                <a class ='btn btn-primary btn-sm'  href="{{ route('tanzaniaRegionFAQ.create',$tanzaniaRegion->uuid) }}">Add Question</a>
            </div>
        </div>
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:100%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('AboutTanzania.tanzaniaRegions.FAQ.getRegionFAQ')
            </section>
        </div>

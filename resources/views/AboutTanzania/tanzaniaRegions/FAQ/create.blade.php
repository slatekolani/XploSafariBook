@extends('layouts.main', ['title' => __("Tanzania region faq"), 'header' => __('Tanzania region faq')])

@include('includes.validate_assets')
@section('content')

    {{ Form::open(['route'=>'tanzaniaRegionFAQ.store', 'autocomplete' => 'off','method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
    @csrf
    <section>

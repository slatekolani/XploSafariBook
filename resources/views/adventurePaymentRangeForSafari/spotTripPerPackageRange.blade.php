@extends('layouts.main', ['title' => __($package_range . ' Local Tour Packages'), 'header' => __('All Local Tour Packages')])
        ...
        <div class="card" style="padding-top: 10px">
            <div class="card-body">
                <div class="card-header bg-primary text-white">
                    <h2 class="mb-0">{{ $package_range }} Tours</h2>
                    <p style="color:#ffd700;font-size:15px">
                        <i>"Local Tour Packages which feature {{ $package_range }}"</i><br>
                        <i>"The {{$package_range}} gives you time to prepare for your trip and complete your payment for the tour"</i>
                    </p>
                </div>
                            ...
                            @empty
                                <div class="col-md-12">
                                    <div class="alert alert-danger rounded-lg shadow-sm" role="alert">
                                        ...
                                        posted packages with {{ $package_range }}. However, we can help you

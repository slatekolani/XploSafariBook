                ...
                <div class="col-lg-12">
                    <section class="card">
                        ...
                        <header class="card-header">
                            ...
                            <h2 class="card-title">@lang('label.crud.create')</h2>
                        </header>

                        <div class="card-body">

                            {{ Form::open(['route' => ['currency.store'],'class' => 'form-horizontal form-bordered', 'id'=>'manifest-form', 'novalidate']) }}
                            ...
                            <div class="form-group row mx-auto">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group"><br>
                                        {{ Form::text('currency_name', null,['class' => 'form-control col-6','id' => 'currency_name', 'required']) }}
                                   </div>
...
<div class="form-group row mx-auto">
  ...
  <div class="col-lg-6">
      <div class="input-group"><br>
          {{ Form::text('currency_symbol', null,['class' => 'form-control col-6','id' => 'currency_name', 'required']) }}
     </div>
...
<div class="form-group row mx-auto">
 ...
 <div class="col-lg-6">
     <div class="input-group"><br>
         {{ Form::text('currency_code', null,['class' => 'form-control col-6','id' => 'currency_name', 'required']) }}
    </div>
...
<div class="col-lg-12">
    <div class="input-group">
        {{ Form::submit(__('label.submit'),['class' => 'col-lg-3 btn btn-primary mx-auto', 'id'=>'manifest-submit']) }}
    </div>
</div>
</div>
</div>

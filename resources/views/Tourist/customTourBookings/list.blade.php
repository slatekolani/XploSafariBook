@extends('layouts.main', ['title' => __('User Custom Tour Booking Information'), 'header' => __('User Custom Tour Booking Information')])
            ...
            <div class="col-md-9">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-upcoming-content" role="tabpanel"
                        ...
                        <div class="px-3 py-2">
                            @include('Tourist.customTourBookings.approvedTrips.listOfApprovedTrips')
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-completed-content" role="tabpanel"
                        aria-labelledby="v-pills-completed-tab">
                        <div class="px-3 py-2">
                            @include('Tourist.customTourBookings.unapprovedTrips.listOfUnapprovedTrips')
                        </div>
                    </div>

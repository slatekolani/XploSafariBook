<div class="container mx-auto px-2 sm:px-4">
    <h2 class="mb-4 text-2xl font-bold text-center text-gray-800">
        <i class="fas fa-plane-departure mr-2"></i> Unapproved Custom Safari's
    </h2>

    @forelse ($customTourBookings as $customTourBooking)
    ...
    @empty
        <div class="text-center py-8 bg-gray-100 rounded-lg">
            ...
            <p class="text-gray-500">No custom trips scheduled.</p>
            <a href="#" onclick="alert('Feature coming soon')" class="btn btn-primary mt-3">
                <i class="fas fa-briefcase"></i> Create Trip Itinerary
            </a>
        </div>
    @endforelse

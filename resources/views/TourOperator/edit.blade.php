                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::number('tin_number',$tourOperator->tin_number, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'tin_number','maxLength'=>'9', 'required']) }}
                                ...
                                <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('tour_company_touristic_activities[]',$touristicActivities,$tourOperatorTouristicActivities, ['class' => 'form-control select2','multiple', 'autocomplete' => 'off', 'id' => 'tour_company_touristic_activities', 'required']) }}

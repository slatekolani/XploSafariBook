@extends('layouts.main', ['title' => trans('Recent Custom Tour Bookings'), 'header' => trans('Recent Custom Tour Bookings')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:300%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.customTourBookings.recentCustomTourBookingsMade.get_recent_custom_tour_bookings_made')
            </section>
        </div>

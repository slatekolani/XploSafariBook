                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-hover table-responsive-md">
                            ...
                            <tr>
                                <th>Tour Duration</th>
                                <td>{{$customTourBooking->DeletedCustomTourDurationLabel}} days</td>
                            </tr>
                            <tr>
                                <th>Countdown Days to Safari</th>
                                <td>{{$customTourBooking->CountDownDaysForADeletedCustomTourLabel}} days</td>
                            </tr>
                            <tr>
                                <th>Start Date</th>
                            ...
                            <tr>
                                <th>Is Expired?</th>
                                <td>
                                    @if ($customTourBooking->CountDownDaysForADeletedCustomTourLabel>=1)

                                        <span class="badge badge-primary">No</span>

                                    @elseif ($customTourBooking->CountDownDaysForADeletedCustomTourLabel==0)

    ...
    <script  type="text/javascript">
        ...
        $(function() {
            ...
            var table= $('#custom_tour_bookings-table').DataTable({
                ...
                ajax: '{{ route('customTourBookings.getDeletedCustomTourBookings',$tourOperator->id) }}',
                columns: [
            ...
            $(document).on('change', '.action_select', function () {
                ...
                if ($(this).val() == 1) {
                    swal({
                        title: "Warning",
                        text: "Are you sure you want to permanently delete this custom booking?",
                        icon: "warning",
                        buttons: {
                            cancel: "Cancel",
                            confirm: {
                ...
                if ($(this).val() == 2) {
                    swal({
                        title: "Warning",
                        text: "Are you sure you want to restore this custom booking?",
                        icon: "warning",
                        buttons: {
                            cancel: "Cancel",
                            confirm: {

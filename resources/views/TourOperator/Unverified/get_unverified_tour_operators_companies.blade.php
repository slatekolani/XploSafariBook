...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table=$('#Unverified_tour_operators_companies-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                initComplete : function () {
                    table.buttons().container().insertBefore('#Unverified_tour_operators_companies-table');
                    $("#Unverified_tour_operators_companies-table").css("width","100%");
                },

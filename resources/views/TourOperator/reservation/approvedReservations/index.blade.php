@extends('layouts.main', ['title' => trans('Approved reservations - ' . $tourOperator->company_name), 'header' => trans('Approved reservations - ' . $tourOperator->company_name)])
    ...
    <div class="row" style="overflow-x: scroll">
        ...
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:150%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.reservation.approvedReservations.get_approved_reservations')
            </section>
        </div>

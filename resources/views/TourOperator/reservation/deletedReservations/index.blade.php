@extends('layouts.main', ['title' => trans('Deleted reservations - ' . $tourOperator->company_name), 'header' => trans('Deleted reservations - ' . $tourOperator->company_name)])
    ...
    <div class="row" style="overflow-x: scroll">
        ...
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:150%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.reservation.deletedReservations.get_deleted_reservations')
            </section>
        </div>

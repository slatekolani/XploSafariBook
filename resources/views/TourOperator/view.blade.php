                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-hover table-responsive-md">
                            ...
                            <tr>
                                <th>Touristic Activities Offered</th>
                                <td>
                                    @foreach($tourOperator->TourOperatorTouristicActivitiesLabel as $touristicActivity)
                                        <a class="region_link" data-toggle="tooltip" data-placement="top"
                                           data-attraction-id="{{$touristicActivity['name']}}" style="color: dodgerblue"
                                           title="{{ $touristicActivity['description'] }}">{{ $touristicActivity['name'] }}</a>,
                                    @endforeach
                                </td>
                            </tr>
                            <tr>

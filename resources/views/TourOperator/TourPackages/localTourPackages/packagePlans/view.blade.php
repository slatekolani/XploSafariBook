@extends('layouts.main', ['title' => __($localTourPackagePackageRangeName . " Local Tour Packages"), 'header' => __("All Local Tour Packages")])
        ...
        <div class="card" style="padding-top: 10px">
            <div class="card-body">
                <div class="card-header bg-primary text-white">
                    <h2 class="mb-0">{{$localTourPackagePackageRangeName}} </h2>
                    <p style="color:#ffd700;font-size:15px"><i>"Local Tour Packages with {{$localTourPackagePackageRangeName}} time frame till tour to be conducted"</i> </p>
                </div>
                        ...
                        <div class="row">
                            @forelse($localTourPackages as $localTourPackage)
                                ...
                                @else
                                    ...
                                    <p style="padding-left: 20px">Thank you for reaching out! Currently, no tour operators have {{$localTourPackagePackageRangeName}} packages. However, we can help you find one. Check us on email for assistance</p>
                                        @php
                            ...
                            @empty
                                <div class="col-md-12">
                                    <p style="padding-left: 20px">Thank you for reaching out! Currently, no tour operators have posted packages with {{$localTourPackagePackageRangeName}}. However, we can help you find one. Check us on email for assistance</p>
                                </div>
                            @endforelse

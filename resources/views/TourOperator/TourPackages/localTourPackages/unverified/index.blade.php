@extends('layouts.main', ['title' => trans('Unverified Tour Packages'), 'header' => trans('Unverified Tour Packages')])
    ...
    <div class="row">
        ...
        <div class="col-md-12" style="overflow-x: scroll">
            <section class="card card-primary mb-4" style="width:180%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.TourPackages.localTourPackages.unverified.get_unverified_local_packages')
            </section>
        </div>

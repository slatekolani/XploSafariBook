<table class="table table-hover table-responsive-md" id="deleted_local_tourist_review-table">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table= $('#deleted_local_tourist_review-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                initComplete : function () {
                    table.buttons().container().insertBefore('#deleted_local_tourist_review-table');
                    $("#deleted_local_tourist_review-table").css("width","100%");
                },
                ...
                ajax: '{{ route('localTouristReview.getDeletedLocalTouristReview',$localTourBooking->id) }}',
                columns: [

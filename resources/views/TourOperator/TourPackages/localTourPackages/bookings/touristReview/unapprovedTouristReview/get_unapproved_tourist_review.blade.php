<table class="table table-hover table-responsive-md" id="unapproved_local_tourist_review-table">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table= $('#unapproved_local_tourist_review-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                initComplete : function () {
                    table.buttons().container().insertBefore('#unapproved_local_tourist_review-table');
                    $("#unapproved_local_tourist_review-table").css("width","100%");
                },
                ...
                ajax: '{{ route('localTouristReview.getUnapprovedLocalTouristReview',$localTourBooking->id) }}',
                columns: [

<table class="table table-hover table-responsive-md" id="approved_local_tourist_review-table">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table= $('#approved_local_tourist_review-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                initComplete : function () {
                    table.buttons().container().insertBefore('#approved_local_tourist_review-table');
                    $("#approved_local_tourist_review-table").css("width","100%");
                },
                ...
                ajax: '{{ route('localTouristReview.getApprovedLocalTouristReview',$localTourBooking->id) }}',
                columns: [

@extends('layouts.main', ['title' =>'Local Tourist Review ' . $localTourBooking->tourist_name, 'header' => __('Local Tourist Review ' . $localTourBooking->tourist_name)])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:120%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.TourPackages.localTourPackages.bookings.touristReview.get_tourist_review')
            </section>
        </div>

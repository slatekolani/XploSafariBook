@extends('layouts.main', ['title' => trans('All Cancelled Local Trip Request'), 'header' => trans('All Cancelled Local Trip Request')])
    ...
    <div class="row" style="overflow-x: scroll">
        ...
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:110%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.TourPackages.localTourPackages.bookings.cancelledBookings.getCancelledBookings')
            </section>
        </div>

@extends('layouts.main', ['title' => trans('Deleted Local Trip Cancellation Request'), 'header' => trans('Deleted Local Trip Cancellation Request')])
    ...
    <div class="row" style="overflow-x: scroll">
        ...
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:110%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.TourPackages.localTourPackages.bookings.cancelledBookings.deletedCancellation.getDeletedCancellations')
            </section>
        </div>

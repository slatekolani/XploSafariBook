<table class="table table-hover table-responsive-md" id="near_international_tour_packages-table" style="background-color: rgba(255,255,255,0.6);color: black">
    <thead>
    <tr>
        <th>@lang('#')</th>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table=$('#near_international_tour_packages-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                initComplete : function () {
                    table.buttons().container().insertBefore('#near_international_tour_packages-table');
                    $("#near_international_tour_packages-table").css("width","100%");
                },
                ...
                ajax: '{{ route('tourPackages.getNearInternationalToursToBeConducted',$tourOperator->id) }}',
                columns: [

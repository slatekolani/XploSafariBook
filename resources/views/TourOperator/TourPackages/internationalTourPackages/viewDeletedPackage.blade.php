@extends('layouts.main', ['title' => __("Deleted Tour Package"), 'header' => __('Deleted Tour Package')])
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12" >
            <div class="pull-left" >
                <a href="{{route('tourPackages.restoreInternationalDeletedTourPackages',$tourPackage->uuid)}}"  class="btn btn-warning btn-sm" style="margin-bottom: 10px;color:white">Restore &blacktriangleright;</a>
            </div>
        </div>
        <div class="col-md-12">
            <div class="row">

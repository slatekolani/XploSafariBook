@extends('layouts.main', ['title' => trans('Un Verified International Tour Packages'), 'header' => trans('Un Verified International Tour Packages')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            ...
            <section class="card card-primary mb-4" style="width:180%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.TourPackages.internationalTourPackages.unverifiedTourPackages.get_unverified_international_tour_packages')
            </section>
        </div>
    </div>

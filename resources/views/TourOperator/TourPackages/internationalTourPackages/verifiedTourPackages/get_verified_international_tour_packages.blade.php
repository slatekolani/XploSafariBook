<table class="table table-hover table-responsive-md" id="verified_international_tour_package-table" style="background-color: rgba(255,255,255,0.6);color: black">
    <thead>
    <tr>
        <th>@lang('#')</th>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table=$('#verified_international_tour_package-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                initComplete : function () {
                    table.buttons().container().insertBefore('#verified_international_tour_package-table');
                    $("#verified_international_tour_package-table").css("width","100%");
                },
                ...
                ajax: '{{ route('tourPackages.getVerifiedInternationalTourPackages',$tourOperator->id) }}',
                columns: [

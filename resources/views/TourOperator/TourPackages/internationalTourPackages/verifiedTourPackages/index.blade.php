@extends('layouts.main', ['title' => trans('Verified International Tour Packages'), 'header' => trans('Verified International Tour Packages')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            ...
            <section class="card card-primary mb-4" style="width:180%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.TourPackages.internationalTourPackages.verifiedTourPackages.get_verified_international_tour_packages')
            </section>
        </div>
    </div>

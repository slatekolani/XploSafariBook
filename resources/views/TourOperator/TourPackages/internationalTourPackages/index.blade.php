@extends('layouts.main', ['title' => trans('International Tour Packages'), 'header' => trans('International Tour Packages')])
    ...
    <div class="row">
        ...
        <div class="col-md-12" style="overflow-x: scroll">
            <section class="card card-primary mb-4" style="width:180%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.TourPackages.internationalTourPackages.get_company_international_tour_packages')
            </section>
        </div>

@extends('layouts.main', ['title' => trans('Recent International Tour Packages'), 'header' => trans('Recent International Tour Packages')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            ...
            <section class="card card-primary mb-4" style="width:180%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.TourPackages.internationalTourPackages.recentPostedTourPackages.get_recent_international_posted_tour_packages')
            </section>
        </div>
    </div>

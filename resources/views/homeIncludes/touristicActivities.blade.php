    ...
    <div class="row">
        <div class="col-md-12">
            <div class="section-header mb-4">
                <h3 class="section-title">Touristic Activities</h3>
                <p class="section-subtitle">Explore activities that match your travel interests</p>
            </div>

            <div class="group-travels-grid">
                @forelse($touristicActivities as $touristicActivity)
                    <div class="group-travel-card">
                        <div class="card group-travel-card-inner h-100 shadow-hover">
                            <a href="{{route('touristicActivity.showActivity',$touristicActivity->uuid)}}" class="group-travel-card-link">
                                <div class="card-image-wrapper">
                                    ...
                                    <div class="card-image-overlay">
                                        <h5 class="group-travel-title">{{ $touristicActivity->activity_name }}</h5>
                                        <span style="color: white">{{strlen($touristicActivity->activity_description) > 38 ? substr($touristicActivity->activity_description,0,38) .'...' : $touristicActivity->activity_description  }}</span>
                                    </div>
                                </div>
                            </a>
                        </div>

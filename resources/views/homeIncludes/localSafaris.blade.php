    ...
    <div class="row">
        <div class="col-md-12">
            <div class="section-header mb-4">
                ...
                <p class="section-subtitle">Experience the beauty of Tanzania’s wildlife and landscapes on a local safari
                    adventure</p>
            </div>
            <div class="row">
                                ...
                                <div class="card-body" style="position: relative; z-index: 2;">
                                    ...
                                    <div style="display: flex">
                                        <h5 class="card-title" style="font-size: 14px;font-weight: bold;color:#ffd700">
                                            &starf; {{ $localTourPackage->tourType->tour_type_name }}</h5>
                                        <h5 class="card-title"

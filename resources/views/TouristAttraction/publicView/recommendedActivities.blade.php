<div class="tab-pane fade" id="nav-recommendedActivities" role="tabpanel" aria-labelledby="nav-recommendedActivities-tab">
    ...
    <div class="col-md-12">
        <div class="section-header mb-4">
            ...
            <p class="section-subtitle">Explore more experience as you are in <a href="{{route('touristicAttraction.show',$touristicAttraction->uuid)}}">{{$touristicAttraction->attraction_name}}</a></p>
        </div>

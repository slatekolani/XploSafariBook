<table class="table table-hover table-responsive-md" id="tourist_attractions_FAQ-table">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table= $('#tourist_attractions_FAQ-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                ajax: '{{ route('touristicAttraction.getTouristicAttractionsFAQ',$touristicAttraction->id) }}',
                columns: [
...
&nbsp; &nbsp;
            ...
            $(document).on('click','#activate_question',function(){
                ...
                $.ajax({
                    type: "GET",
                    dataType: "JSON",
                    url: '{{route('touristicAttraction.activateFAQ')}}',

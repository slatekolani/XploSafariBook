                ...
                <div class="card-body" style="background-color: rgba(255,255,255,0.85); margin-top: 3px">
                    <div class="col-md-12">
                        ...
                        <div class="star-rating">
                            @php
                                $currentRating = $tour_type->rating ?? 0; 
                            @endphp
                            ...
                            @for ($i = 10; $i >= 1; $i--)
                                <input type="radio" 
                                       ...
                                       required />
                                <label for="star{{ $i }}" class="star" title="{{ $i }} stars">&#9733;</label>
                            @endfor
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8 col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('tour_type_description', $tour_type->tour_type_description, ['class' => 'form-control','maxLength'=>'200','style'=>'height:100px', 'autocomplete' => 'off', 'id' => 'tour_type_description', 'required']) }}

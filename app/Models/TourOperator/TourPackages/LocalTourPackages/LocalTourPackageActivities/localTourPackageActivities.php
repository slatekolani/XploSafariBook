...
namespace App\Models\TourOperator\TourPackages\LocalTourPackages\LocalTourPackageActivities;
...
class localTourPackageActivities extends BaseModel
{
    use SoftDeletes;
    protected $table='local_tour_package_activities';

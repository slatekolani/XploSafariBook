...
class CreateLocalTourPackagePriceExclusivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('local_package_price_exclusives', function (Blueprint $table) {
        ...
        Schema::table('local_package_price_exclusives',function (Blueprint $table){
    ...
    {
        Schema::dropIfExists('local_tour_package_price_exclusives');
    }
}
